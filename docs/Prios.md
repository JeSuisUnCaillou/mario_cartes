...
> 
> Méga chompchomp : fait avancer de 2 case en étant immunisé au défausse et détruit un objet ou entre en collision avec un joueur sur chaque case traversé -> comme une étoile magique, mais avance de 2 cases
> 
> Fantôme : permet de se déplacer ce tour ci sans interagir avec les objets posé au sol (banane, carapace…) + déplace d’une case.
> 
